    ...
    <div class="container-post-big d-flex flex-row justify-content-evenly align-items-center">
      ...
      <div class="buttonandanalytics">
        <div class="post-analytics-big d-flex flex-row justify-content-evenly align-items-center">
          ...
          >
            <a
              class="shr d-flex flex-row gap-2 justify-content-center align-items-center"
              role="button"
        ...
        <div
          v-if="post.author === authorname"
          class="bookmark-btn-big d-flex justify-content-center align-items-center pb-3"
        >
          <a
            class="bookmarkbtn btn d-flex justify-content-center"
            role="button"
            style="text-decoration: none; color: var(--dark)"
            @click="deletepost"
        ...
        <div v-else class="bookmark-btn-big d-flex justify-content-center align-items-center pb-3">
          <a
