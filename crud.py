...
def update_acc(request: Request, db: Session, First_name: str, Last_name: str, email_new: str, Username: str):
...
def upload_photo(db: Session, request: Request, file: UploadFile = None):
    ...
    if file and file.filename.strip():
        upload_dir = "static/Assets/ProfileImg"
        ...
        user.ProfilePhoto = file_location
        db.commit()
        db.refresh(user)
